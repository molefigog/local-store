...
<html lang="en" class="light-style layout-menu-fixed" dir="ltr" data-theme="theme-default"
    data-assets-path="<?php echo e('assets'); ?>" data-template="vertical-menu-template-free">
...
<head>
    ...
    <title><?php echo e($setting->site ?? config('app.name')); ?></title>
    ...
    <?php echo $__env->yieldPushContent('iconcss'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/fontello.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/gee.css')); ?>" />
...
<body>
<?php /**PATH /home/gw-ent.co.za/public_html/resources/views/admin/components/header.blade.php ENDPATH**/ ?>