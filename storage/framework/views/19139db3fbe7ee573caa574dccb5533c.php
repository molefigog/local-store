...
<div class="container mt-5">
    <div class="row">
        <div class="card-img-wrapper col-md-6 ">
            <img src="<?php echo e($music->image ? \Storage::url($music->image) : ''); ?>" class="img-fluid" alt="Product Image">
        </div>
        <div class="col-md-6">
            ...
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                    <div class="justify-content-center">
                        <hr>
                        <div id="wrap">
                            <form class="text-center" action="<?php echo e(route('m-pesa')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <div class="mb-3">
                ...
                <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                    ...
                    <div class="text-center">
                        ...
                        <div id="wrap">
                            <form action="<?php echo e(route('buy-music')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                        ...
                        <div id="wrap">
                            <form action="<?php echo e(route('buy-music')); ?>" method="post">
                                ...
                                <button type="submit" class="btn buy-button2">
                                    ...
                                    <span class="title2 gee">Buy R<?php echo e($music->amount); ?></span>
            ...
            <div id="wrapper">
                <audio preload="auto" controls>
                    <source src="<?php echo e(\Storage::url($music->demo)); ?>">
                </audio>
