...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea id="form_message" name="description" class="form-control"
                                ...
                                :required="!$editing"><?php echo e(old('description', $editing ? $music->description : '')); ?></textarea>
                        </div>
                    </div>
                </div>
    ...
    </div><?php /**PATH /home/gw-ent.co.za/public_html/resources/views/all_music/form-inputs.blade.php ENDPATH**/ ?>