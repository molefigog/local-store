    ...
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">
                ...
                ></a>
                <?php echo app('translator')->get('edit Genre'); ?>
            </h4>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form','data' => ['method' => 'PUT','action' => ''.e(route('genres.update', $genre)).'','hasFiles' => true,'class' => 'mt-4']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['method' => 'PUT','action' => ''.e(route('genres.update', $genre)).'','has-files' => true,'class' => 'mt-4']); ?>
                ...
                <div class="mt-4">
                    ...
                    <a
                        href="<?php echo e(route('genres.create')); ?>"
                        class="btn btn-light"
                    >
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gw-ent.co.za/public_html/resources/views/genres/edit.blade.php ENDPATH**/ ?>