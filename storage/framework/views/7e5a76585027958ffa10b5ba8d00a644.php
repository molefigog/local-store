...
<div class="layout-wrapper layout-content-navbar">
    <div class="layout-container">
                              ...
                              <div class="card-title d-flex align-items-start justify-content-between">
                                ...
                                <div class="dropdown">
                                  ...
                                  <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt3" style="">
                                    ...
                                    <a href="<?php echo e(url('/posts')); ?>" class="dropdown-item">Posts</a>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="card-title d-flex align-items-start justify-content-between">
                                ...
                                <div class="dropdown">
                                  ...
                                  <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt6" style="">
                                    <a href="<?php echo e(url('/all-music')); ?>" class="dropdown-item">Music</a>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="card-title d-flex align-items-start justify-content-between">
                                ...
                                <div class="dropdown">
                                  ...
                                  <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt4">
                                    <a href="<?php echo e(route('users.index')); ?>" class="dropdown-item">Users </a>
                                  </div>
                                </div>
                              </div>
        ...
        <div class="row"> -->
                ...
                <?php /**PATH /home/gw-ent.co.za/public_html/resources/views/admin/dash.blade.php ENDPATH**/ ?>