                                ...
                                <ul class="dropdown">
                                    <?php if(Auth::check()): ?>
                                      ...
                                      <?php if(Auth::user()->upload_status == 1): ?>
                                       ...
                                       <li><a class="nav-link" href="<?php echo e(url('/sales')); ?>"><i class="icon-account_balance_wallet"></i> Wallet</a></li>
                                       <?php endif; ?>
                                       <li><a class="nav-link" href="<?php echo e(url('/purchased-musics')); ?>"><i class="icon-download"></i> Downloads</a></li>
                                       <li><a class="nav-link" href="<?php echo e(url('/top-up')); ?>"><i class="fa fa-cart-plus"></i> Deposit</a></li>
