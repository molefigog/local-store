@php
    ...
    $baseCurrency = 'ZAR';
    $targetCurrency = 'USD';
    $amount = '100'; // Assuming $music->amount contains the ZAR amount you want to convert
                        ...
                        <nav class="text-center">
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                ...
                                <a class="nav-link" id="nav-profile-tab" data-bs-toggle="tab" href="#nav-profile"
                                    role="tab" aria-controls="nav-profile" aria-selected="false">M-Pesa</a>
                                <a class="nav-link" id="nav-contact-tab" data-bs-toggle="tab" href="#nav-contact"
                                    role="tab" aria-controls="nav-contact" aria-selected="false">Paypal</a>
                            </div>
                        </nav>
                                            ...
                                            <div class="card">
                                                ...
                                                @if ($songs->count() > 0)
                                                    <table border="1">
                                                        <thead>
                                                            <tr>
                                                                <th class=""><i class="icon-library_music text-muted"></i><span class="card-text"> Tracks</span></th>
                                                                <th><i class="icon-cloud-download text-muted"></i><span class="card-text"> Downloads</span></th>
                                                                <th><i class="icon-monetization_on text-muted"></i><span class="card-text"> Price</span></th>
                                                                <th><i class="icon-drag_handle text-muted"></i><span class="card-text"> Total</span></th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
