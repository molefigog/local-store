        ...
        <form id="registerForm" method="POST" action="{{ route('register') }}">
            ...
            <div class="mb-3">
                ...
                <div class="input-group mb-2">
                    ...
                    <input id="name" type="text" placeholder="User name or Artist name"
                        class="form-control @error('login') is-invalid @enderror" name="name" value="{{ old('login') }}"
            ...
            <div class="mb-3">
                ...
                <div class="input-group mb-2">
                    ...
                    <input id="phone" type="tel" class="form-control @error('mobile_number') is-invalid @enderror"
                        name="mobile_number" value="{{ old('mobile_number') }}" required autocomplete="phone number">
