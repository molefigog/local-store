    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-6 col-xl-2">
                <h1 class="mb-0 site-logo"><a href="/"><img src="{{ asset("storage/$setting->logo") }}"
                            ...
                            <ul class="dropdown">
                                @if (Auth::check())
                                    ...
                                    @if (Auth::user()->upload_status == 1)
                                        <li><a class="nav-link" href="{{ url('/admin/music/create') }}"><i
                                                    class="icon-upload"></i> Upload Music</a></li>
                                        <li><a class="nav-link" href="{{ url('/admin/beats/create') }}"><i
                                                    class="icon-upload"></i> Upload Beat</a></li>
                                        <!--{{-- <li><a class="nav-link" href="{{ url('/sales') }}"><i class="icon-account_balance_wallet"></i> Wallet</a></li> --}}-->
                                    @endif
                                    <li><a class="nav-link" href="{{ url('/purchased-musics') }}"><i
                                                class="icon-download"></i> Downloads</a></li>
                                    <li><a class="nav-link" href="{{ url('/top-up') }}"><i class="fa fa-cart-plus"></i>
                                            Account <span
                                                class="badge bg-success">R{{ Auth::user()->balance }}</span></a></li>

                                    <li><a class="nav-link" href="{{ url('edit-profile') }}"><i class="icon-user"></i>
                                            Profile</a></li>
                                    <li><a class="nav-link" href="{{ route('log') }}"><i class="icon-paypal"></i>
                                            Paypal History</a></li>
                                    <li><a class="nav-link" href="{{ url('/admin') }}"><i class="icon-dashboard"></i>
                                            Dashboard</a></li>
                                @else
            ...
            <div class="d-flex justify-content-between">
                @if (Auth::check())
                    <div class="mb-8 align-items-center text-center">
                        <button class="btn btn-outline-light btn-sm">Wallet R{{ Auth::user()->balance }}</button>
                    </div>
                @endif
                &nbsp; &nbsp;&nbsp;
                ...
                @if (Auth::check())
                    <div class="mb-8 align-items-center text-center">
                        <a class="btn btn-outline-light btn-sm" href="{{ url('/admin/music/create') }}"> <i
